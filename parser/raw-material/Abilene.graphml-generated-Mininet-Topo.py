...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        # add nodes
        # switches first
        New York = self.addSwitch( 's0' )
        New York_host = self.addHost( 'h0' )
        ...
        Los Angeles = self.addSwitch( 's5' )
        Los Angeles_host = self.addHost( 'h5' )
        Denver = self.addSwitch( 's6' )
        Denver_host = self.addHost( 'h6' )
        Kansas City = self.addSwitch( 's7' )
        Kansas City_host = self.addHost( 'h7' )
        ...
        # add edges
        self.addLink( New York , Chicago, bw=30, delay='0.690677696537ms')
        self.addLink( New York , New York_host )
        self.addLink( New York , Washington DC, bw=30, delay='0.518903303662ms')
        self.addLink( New York , New York_host )
        self.addLink( Chicago , Indianapolis, bw=30, delay='1.15170240387ms')
        self.addLink( Chicago , Chicago_host )
        self.addLink( Washington DC , Atlanta, bw=30, delay='0.477628158502ms')
        self.addLink( Washington DC , Washington DC_host )
        self.addLink( Seattle , Sunnyvale, bw=30, delay='1.10351797289ms')
        self.addLink( Seattle , Seattle_host )
        self.addLink( Seattle , Denver, bw=30, delay='0.952189623151ms')
        self.addLink( Seattle , Seattle_host )
        self.addLink( Sunnyvale , Los Angeles, bw=30, delay='0.506044716762ms')
        self.addLink( Sunnyvale , Sunnyvale_host )
        self.addLink( Sunnyvale , Denver, bw=30, delay='0.85423284091ms')
        self.addLink( Sunnyvale , Sunnyvale_host )
        self.addLink( Los Angeles , Houston, bw=30, delay='1.02920365882ms')
        self.addLink( Los Angeles , Los Angeles_host )
        self.addLink( Denver , Kansas City, bw=30, delay='0.191285963954ms')
        self.addLink( Denver , Denver_host )
        self.addLink( Kansas City , Houston, bw=30, delay='1.46743666378ms')
        self.addLink( Kansas City , Kansas City_host )
        self.addLink( Kansas City , Indianapolis, bw=30, delay='0.206336052247ms')
        self.addLink( Kansas City , Kansas City_host )
        self.addLink( Houston , Atlanta, bw=30, delay='1.15068985002ms')
        self.addLink( Houston , Houston_host )
        self.addLink( Atlanta , Indianapolis, bw=30, delay='0.466772343871ms')
