...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        self.addLink( NewYork , WashingtonDC, bw=100, delay='0.518903303662ms')
        self.addLink( NewYork , NewYork_host )
        self.addLink( Chicago , Indianapolis, bw=100, delay='1.15170240387ms')
        self.addLink( Chicago , Chicago_host )
        self.addLink( WashingtonDC , Atlanta, bw=100, delay='0.477628158502ms')
        self.addLink( WashingtonDC , WashingtonDC_host )
        self.addLink( Seattle , Sunnyvale, bw=100, delay='1.10351797289ms')
        self.addLink( Seattle , Seattle_host )
        self.addLink( Seattle , Denver, bw=100, delay='0.952189623151ms')
        self.addLink( Seattle , Seattle_host )
        self.addLink( Sunnyvale , LosAngeles, bw=100, delay='0.506044716762ms')
        self.addLink( Sunnyvale , Sunnyvale_host )
        self.addLink( Sunnyvale , Denver, bw=100, delay='0.85423284091ms')
        self.addLink( Sunnyvale , Sunnyvale_host )
        self.addLink( LosAngeles , Houston, bw=100, delay='1.02920365882ms')
        self.addLink( LosAngeles , LosAngeles_host )
        self.addLink( Denver , KansasCity, bw=100, delay='0.191285963954ms')
        self.addLink( Denver , Denver_host )
        self.addLink( KansasCity , Houston, bw=100, delay='1.46743666378ms')
        self.addLink( KansasCity , KansasCity_host )
        self.addLink( KansasCity , Indianapolis, bw=100, delay='0.206336052247ms')
        self.addLink( KansasCity , KansasCity_host )
        self.addLink( Houston , Atlanta, bw=100, delay='1.15068985002ms')
        self.addLink( Houston , Houston_host )
        self.addLink( Atlanta , Indianapolis, bw=100, delay='0.466772343871ms')
