...
echo 'log server'
bash -i -l -c 'sshpass -p mininet ssh mininet@10.0.0.3 "sudo ITGLog 0>/dev/null" &'

echo 'client 1'
bash -i -l -c 'sshpass -p mininet ssh mininet@10.0.0.1 "sudo ITGRecv 0>/dev/null" &'
echo 'client 2'
...
echo 'server 2'
bash -i -l -c 'sshpass -p mininet ssh mininet@10.0.0.5 "sudo ktr/ITGscripts/ITGSendUDP 10.0.0.2 1 10.0.0.3 0>/dev/null" &'
